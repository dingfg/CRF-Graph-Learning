...
%     tline='2007_000129';
    ...
    left = load(strcat('./infer_left/',matname));
    top = load(strcat('./infer_top/',matname));
    ul = load(strcat('./infer_ul/',matname));
    ur = load(strcat('./infer_ur/',matname));  
...
% mean_IU: 0.603060552455160
% a = [36450,26096;43012,427405];
% b = sum(a,2);
% c = repmat(b,1,2);
% m = a ./ c;
% [0.582771080484763,0.417228919515237;
%  0.091433770463227,0.908566229536773]
