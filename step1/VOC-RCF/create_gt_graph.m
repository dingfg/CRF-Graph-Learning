...
while ~feof(fid)
    ...
    fprintf(fid2,'train_rcf/img/%s train_rcf/gt/gt_left/%s\n',[tline '.jpg'], [tline '.png']);
    fprintf(fid3,'train_rcf/img/%s train_rcf/gt/gt_top/%s\n',[tline '.jpg'], [tline '.png']);          
    fprintf(fid4,'train_rcf/img/%s train_rcf/gt/gt_ul/%s\n',[tline '.jpg'], [tline '.png']);
    fprintf(fid5,'train_rcf/img/%s train_rcf/gt/gt_ur/%s\n',[tline '.jpg'], [tline '.png']);
