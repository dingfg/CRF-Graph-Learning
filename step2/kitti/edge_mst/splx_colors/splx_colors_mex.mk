...
MAKEFILE = splx_colors_mex.mk

include splx_colors_mex.mki
...
SRC_FILES =  \
	...
	find.c \
	sum.c \
	splx_colors_initialize.c \
	splx_colors_terminate.c \
	splx_colors_api.c \
	splx_colors_emxutil.c \
	splx_colors_mex.c

MEX_FILE_NAME_WO_EXT = splx_colors_mex
...
SYS_INCLUDE += -I "/home/ccadena/Dropbox/GMU/temp/codegen/mex/splx_colors"
SYS_INCLUDE += -I "/home/ccadena/Dropbox/GMU/GMUcode/utils"
...
%.$(OBJEXT) : /home/ccadena/Dropbox/GMU/temp/codegen/mex/splx_colors/%.c
	$(CC) $(CCFLAGS) "$<"



%.$(OBJEXT) : /home/ccadena/Dropbox/GMU/temp/codegen/mex/splx_colors/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
