...
void b_emxInit_real32_T(emxArray_real32_T **pEmxArray, int32_T numDimensions, const emlrtRTEInfo *srcLocation, boolean_T doPush)
{
    ...
    *pEmxArray = (emxArray_real32_T *)malloc(sizeof(emxArray_real32_T));
    ...
    if (doPush) {
        emlrtPushHeapReferenceStack((void *)pEmxArray, (void (*)(void *, boolean_T))emxFree_real32_T);
    }
    emxArray = *pEmxArray;
...
void emxInit_real32_T(emxArray_real32_T **pEmxArray, int32_T numDimensions, const emlrtRTEInfo *srcLocation, boolean_T doPush)
{
    emxArray_real32_T *emxArray;
    int32_T loop_ub;
    int32_T i;
...
/* End of code generation (splx_colors_emxutil.c) */
